...
export default function FooterSection() {
  return (
    <footer id="footer" className="relative w-full overflow-hidden">
      ...
      {/* Banner Card Container: Di mobile dibikin compact */}
      <div className="flex p-6 justify-center items-center w-full h-[752px] relative max-md:p-4 max-md:h-auto">
        <div className="shrink-0 rounded-[18px] w-full max-w-[1232px] h-[704px] relative overflow-hidden max-md:h-[430px] max-md:rounded-[20px] max-md:p-4">
          ...
          <Image
            ...
            fill
            className="rounded-[18px] max-md:rounded-[20px] object-cover -z-10"
          />

          {/* CTA Button Desktop (Tengah) */}
          ...
          {/* Header Kanan Atas & CTA Button Mobile */}
          ...
          <div className="w-[436px] h-[212px] absolute left-6 top-[468px] max-md:left-3.5 max-md:bottom-3 max-md:top-auto max-md:w-[calc(100%-28px)] max-md:h-auto z-20">
            ...
            {/* Tag 1 (Pink / Fast Answers): Kiri atas judul */}
            ...
            {/* Tag 2 (Ungu / Rank Points): Nempel di atas baris terakhir judul */}
            ...
            {/* Tag 3 (Hijau / Voice Duel): Di sebelah kanan mengambang di atas bukit */}
